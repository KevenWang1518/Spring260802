...
public class ProxyTest3_Lambda {
    @Test
    public void dynamicProxyTest() {
        //创建一个目标对象
        ProductService target = new ProductServiceImpl();

        //创建一个代理对象（其中InvocationHandler直接Lambda实现）
        ProductService proxy = (ProductService) Proxy.newProxyInstance(target.getClass().getClassLoader(), target.getClass().getInterfaces(),
    ...
    /*
        正在读取商品信息......
        com.wyjun.proxy.service.ProductServiceImpl's getProduct() running : 3012ms
        iPhone Pro Max Ultra
        正在删除商品信息......
        com.wyjun.proxy.service.ProductServiceImpl's removeById() running : 2015ms
     */
}
